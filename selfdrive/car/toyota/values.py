...
DBC = {
  ...
  CAR.PRIUS_PRIME: dbc_dict('toyota_prius_prime_2020_pt', 'toyota_adas'),
...
HD_STEER_SENSOR_CARS = [CAR.CHR, CAR.CHRH, CAR.CAMRY, CAR.CAMRYH, CAR.RAV4_TSS2, CAR.COROLLA_TSS2, CAR.LEXUS_ESH_TSS2, CAR.PRIUS_PRIME]
